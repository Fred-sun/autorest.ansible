              ...
              image:
                description:
                  - >-
                    ...
                    machine. If SourceImage is provided, the destination virtual
                    hard drive must not exist.
                type: dict
                suboptions:
                  uri:
                    description:
              ...
              disk_mbps_read_write:
                description:
                  - >-
                    ...
                    disk when StorageAccountType is UltraSSD_LRS. Returned only
                    for VirtualMachine ScaleSet VM disks. Can be updated only
          ...
          computer_name:
            description:
              - >-
                ...
                (Windows):** 15 characters :code:`<br>`:code:`<br>` **Max-length
                (Linux):** 64 characters. :code:`<br>`:code:`<br>` For naming
            ...
            description:
              - >-
                ...
                **Disallowed values:** "administrator", "admin", "user",
                ...
                (Linux):** 1  character :code:`<br>`:code:`<br>` **Max-length
                (Linux):** 64 characters :code:`<br>`:code:`<br>` **Max-length
                (Windows):** 20 characters  :code:`<br>`:code:`<br>`:code:`<li>`
          ...
          custom_data:
            description:
              - >-
                ...
                :code:`<br>`:code:`<br>` This property cannot be updated after
                the VM is created. :code:`<br>`:code:`<br>` customData is passed
                to the VM to be saved as a file, for more information see
      ...
      virtual_machine_scale_set:
        description:
          - >-
            ...
            the same virtual machine scale set are allocated to different nodes
            to maximize availability. Currently, a VM can only be added to
            virtual machine scale set at creation time. An existing VM cannot be
            added to a virtual machine scale set. :code:`<br>`:code:`<br>`This
      ...
      instance_view:
        ...
        suboptions:
              ...
              console_screenshot_blob_uri:
                description:
                  - >-
                    ...
                    :code:`<br>`:code:`<br>`NOTE: This will **not** be set if
          ...
          assigned_host:
            description:
              - >-
                Resource id of the dedicated host, on which the virtual machine
                is allocated through automatic placement, when the virtual
                machine is associated with a dedicated host group that has
                automatic placement enabled. :code:`<br>`:code:`<br>`Minimum
              ...
              available_patch_summary:
                ...
                suboptions:
                  status:
                    description:
                      - >-
                        ...
                        It remains "InProgress" until the operation completes.
                  ...
                  assessment_activity_id:
                    description:
                      - >-
                        ...
                        result. It is used to correlate across CRP and extension
                        logs.
                    type: str
                  reboot_pending:
                    description:
                      - >-
                        ...
                        when partially installed patches require a reboot to
                        complete installation but the reboot has not yet
                        occurred.
                    type: bool
                  ...
                  other_patch_count:
                    description:
                      - >-
                        The number of all available patches excluding critical
                        and security.
                    type: integer
                  start_time:
                    description:
              ...
              last_patch_installation_summary:
                ...
                suboptions:
                  ...
                  maintenance_window_exceeded:
                    description:
                      - >-
                        Describes whether the operation ran out of time before
                        it completed all its intended actions
                    type: bool
                  reboot_status:
                    description:
                      - >-
                        The reboot status of the machine after the patch
                        operation. It will be in "NotNeeded" status if reboot is
                        not needed after the patch operation. "Required" will be
                        the status once the patch is applied and machine is
                        required to reboot. "Started" will be the reboot status
                        when the machine has started to reboot. "Failed" will be
                        the status if the machine is failed to reboot.
                        "Completed" will be the status once the machine is
                  ...
                  pending_patch_count:
                    description:
                      - >-
                        ...
                        installed over the course of the patch installation
                        operation.
                    type: integer
                    ...
                    instance_view=dict(
                        ...
                        options=dict(
                            ...
                            boot_diagnostics=dict(
                                ...
                                disposition='boot_diagnostics',
                                options=dict(
                                    console_screenshot_blob_uri=dict(
                                        type='str',
                                        updatable=False,
                                        disposition='console_screenshot_blob_uri'
                                    ),
                                    serial_console_log_blob_uri=dict(
                                        type='str',
                                        updatable=False,
                                        disposition='serial_console_log_blob_uri'
                                    ),
                                    status=dict(
                                        type='dict',
                                        updatable=False,
                                ...
                                options=dict(
                                    available_patch_summary=dict(
                                        ...
                                        options=dict(
                                            ...
                                            assessment_activity_id=dict(
                                                type='str',
                                                updatable=False,
                                                disposition='assessment_activity_id'
                                            ),
                                            reboot_pending=dict(
                                                type='bool',
                                                updatable=False,
                                                disposition='reboot_pending'
                                            ),
                                            critical_and_security_patch_count=dict(
                                                type='integer',
                                                updatable=False,
                                                disposition='critical_and_security_patch_count'
                                            ),
                                            other_patch_count=dict(
                                                type='integer',
                                                updatable=False,
                                                disposition='other_patch_count'
                                            ),
                                            start_time=dict(
                                                type='str',
                                                updatable=False,
                                    ...
                                    last_patch_installation_summary=dict(
                                        ...
                                        options=dict(
                                            ...
                                            installation_activity_id=dict(
                                                type='str',
                                                updatable=False,
                                                disposition='installation_activity_id'
                                            ),
                                            maintenance_window_exceeded=dict(
                                                type='bool',
                                                updatable=False,
                                                disposition='maintenance_window_exceeded'
                                            ),
                                            reboot_status=dict(
                                                type='choice',
                                                updatable=False,
                                                disposition='reboot_status'
                                            ),
                                            not_selected_patch_count=dict(
                                                type='integer',
                                                updatable=False,
                                                disposition='not_selected_patch_count'
                                            ),
                                            excluded_patch_count=dict(
                                                type='integer',
                                                updatable=False,
                                                disposition='excluded_patch_count'
                                            ),
                                            pending_patch_count=dict(
                                                type='integer',
                                                updatable=False,
                                                disposition='pending_patch_count'
                                            ),
                                            installed_patch_count=dict(
                                                type='integer',
                                                updatable=False,
                                                disposition='installed_patch_count'
                                            ),
                                            failed_patch_count=dict(
                                                type='integer',
                                                updatable=False,
                                                disposition='failed_patch_count'
                                            ),
                                            start_time=dict(
                                                type='str',
                                                updatable=False,
