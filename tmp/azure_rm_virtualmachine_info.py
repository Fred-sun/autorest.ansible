                ...
                console_screenshot_blob_uri:
                  description:
                    - >-
                      ...
                      boot diagnostics is currently enabled with managed
                      storage.
                  returned: always
                  type: str
                  sample: null
            ...
            assigned_host:
              description:
                - >-
                  ...
                  has automatic placement enabled.
                ...
                available_patch_summary:
                  ...
                  contains:
                    status:
                      description:
                        - >-
                          The overall success or failure status of the
                          operation. It remains "InProgress" until the operation
                          completes. At that point it will become "Failed",
                    ...
                    assessment_activity_id:
                      description:
                        - >-
                          ...
                          result. It is used to correlate across CRP and
                          extension logs.
                      returned: always
                      type: str
                      sample: null
                    ...
                    reboot_status:
                      description:
                        - >-
                          ...
                          operation. It will be in "NotNeeded" status if reboot
                          is not needed after the patch operation. "Required"
                          will be the status once the patch is applied and
                          machine is required to reboot. "Started" will be the
                          reboot status when the machine has started to reboot.
                          "Failed" will be the status if the machine is failed
                          to reboot. "Completed" will be the status once the
                          machine is rebooted successfully
                      returned: always
                      type: choice
                      sample: null
                    not_selected_patch_count:
                      description:
                        - >-
                          ...
                          be installed because it didn't match a classification
                          or inclusion list entry.
                      returned: always
                      type: integer
                      sample: null
                    excluded_patch_count:
                      description:
                        - >-
                          ...
                          explicitly by a customer-specified exclusion list
                          match.
                      returned: always
                      type: integer
                      sample: null
        ...
        license_type:
          description:
            - >-
              ...
              If this element is included in a request for an update, the value
              must match the initial value. This value cannot be updated.
            ...
            console_screenshot_blob_uri:
              description:
                - >-
                  ...
                  This will **not** be set if boot diagnostics is currently
        ...
        assigned_host:
          description:
            - >-
              ...
              placement enabled. :code:`<br>`:code:`<br>`Minimum api-version:
              2020-06-01.
          returned: always
          type: str
          sample: null
                ...
                status:
                  description:
                    - >-
                      ...
                      remains "InProgress" until the operation completes. At
                ...
                reboot_status:
                  description:
                    - >-
                      ...
                      the status if the machine is failed to reboot. "Completed"
                      will be the status once the machine is rebooted
                      successfully
                  returned: always
                  type: choice
                  sample: null
