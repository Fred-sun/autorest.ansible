        ...
        table_service_properties:
          ...
          contains:
            cors:
              description:
                - >-
                  Specifies CORS rules for the Table service. You can include up
                  to five CorsRule elements in the request. If no CorsRule
                  elements are included in the request body, all CORS rules will
                  be deleted, and CORS will be disabled for the Table service.
              returned: always
              type: dict
              sample: null
              contains:
...
class AzureRMTableServiceInfo(AzureRMModuleBase):
    ...
    def exec_module(self, **kwargs):
        ...
        if (self.resource_group_name is not None and
            ...
            self.table_service_name is not None):
            self.results['table_services'] = self.format_item(self.getserviceproperties())
    ...
    def getserviceproperties(self):
        ...
        try:
            response = self.mgmt_client.table_services.get_service_properties(resource_group_name=self.resource_group_name,
                                                                              account_name=self.account_name,
                                                                              table_service_name=self.table_service_name)
