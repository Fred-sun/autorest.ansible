...
class AzureRMVirtualMachineScaleSetRollingUpgrade(AzureRMModuleBaseExt):
    ...
    def exec_module(self, **kwargs):
        ...
        if not old_response:
            self.log("VirtualMachineScaleSetRollingUpgrade instance doesn't exist")
            ...
            self.log('VirtualMachineScaleSetRollingUpgrade instance already exists')
        ...
        if (self.to_do == Actions.Create) or (self.to_do == Actions.Update):
            self.log('Need to Create / Update the VirtualMachineScaleSetRollingUpgrade instance')
            ...
            self.log('VirtualMachineScaleSetRollingUpgrade instance deleted')
            self.results['changed'] = True
            ...
            self.log('VirtualMachineScaleSetRollingUpgrade instance unchanged')
    ...
    def get_resource(self):
        ...
        try:
            ...
            # self.log("VirtualMachineScaleSetRollingUpgrade instance : {0} found".format(response.name))
        except CloudError as e:
            self.log('Did not find the VirtualMachineScaleSetRollingUpgrade instance.')
        if found is True:
            return response
