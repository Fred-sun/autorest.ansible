...
class AzureRMDiskEncryptionSet(AzureRMModuleBaseExt):
    def __init__(self):
        self.module_arg_spec = dict(
            ...
            encryption_type=dict(
                type='choice',
                disposition='/properties/encryptionType'
            ),
            key_url=dict(
                type='str',
                disposition='/properties/keyUrl'
            ),
            id=dict(
                type='str',
            ...
            active_key=dict(
                type='dict',
                disposition='/properties/activeKey',
                options=dict(
                    key_url=dict(
                        type='str',
                        disposition='/keyUrl',
    ...
    def exec_module(self, **kwargs):
        ...
        if not old_response:
            self.log("DiskEncryptionSet instance doesn't exist")
            ...
            self.log('DiskEncryptionSet instance already exists')
        ...
        if (self.to_do == Actions.Create) or (self.to_do == Actions.Update):
            self.log('Need to Create / Update the DiskEncryptionSet instance')
            ...
            self.log('DiskEncryptionSet instance deleted')
            self.results['changed'] = True
            ...
            self.log('DiskEncryptionSet instance unchanged')
    ...
    def get_resource(self):
        ...
        try:
            ...
            # self.log("DiskEncryptionSet instance : {0} found".format(response.name))
        except CloudError as e:
            self.log('Did not find the DiskEncryptionSet instance.')
        if found is True:
            return response
