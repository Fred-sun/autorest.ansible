...
class AzureRMGalleryInfo(AzureRMModuleBase):
    def __init__(self):
        ...
        self.mgmt_client = None
        super(AzureRMGallery, self).__init__(self.module_arg_spec, supports_tags=True)
    ...
    def exec_module(self, **kwargs):
        ...
        if (self.subscription_id is not None and
            ...
            self.results['null'] = self.format_item(self.createorupdate())
        elif (self.subscription_id is not None and
              self.resource_group is not None and
              self.gallery_name is not None and
              self.apiversion is not None and
              self.gallery is not None):
            self.results['null'] = self.format_item(self.update())
        elif (self.subscription_id is not None and
              self.resource_group is not None and
              self.gallery_name is not None and
            ...
            self.results['null'] = self.format_item(self.get())
              ...
              self.gallery_name is not None and
              self.apiversion is not None):
            self.results['null'] = self.format_item(self.delete())
        elif (self.subscription_id is not None and
              self.resource_group is not None and
              self.apiversion is not None):
