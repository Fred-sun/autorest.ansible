...
class AzureRMGalleryImageVersion(AzureRMModuleBaseExt):
    def __init__(self):
        self.module_arg_spec = dict(
            ...
            data_disk_images=dict(
                type='list',
                disposition='/properties/dataDiskImages'
            ),
            host_caching=dict(
                type='sealed-choice',
                disposition='/properties/hostCaching'
            ),
            id=dict(
                type='str',
            ...
            gallery_artifact_version_source_id=dict(
                type='str',
                disposition='/properties/galleryArtifactVersionSourceId'
            ),
            target_regions=dict(
                type='list',
                disposition='/properties/targetRegions'
            ),
            replica_count=dict(
                type='integer',
                disposition='/properties/replicaCount'
            ),
            exclude_from_latest=dict(
                type='bool',
                disposition='/properties/excludeFromLatest'
            ),
            ...
            storage_account_type=dict(
                type='choice',
                disposition='/properties/storageAccountType'
            ),
            expand=dict(
                type='choice'
            ),
    ...
    def exec_module(self, **kwargs):
        ...
        self.url = self.url.replace('{galleryImageVersionName}', self.gallery_image_version_name)
