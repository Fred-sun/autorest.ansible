...
class AzureRMDedicatedHostGroup(AzureRMModuleBaseExt):
    def __init__(self):
        self.module_arg_spec = dict(
            ...
            support_automatic_placement=dict(
                type='bool',
                disposition='/properties/supportAutomaticPlacement'
            ),
            expand=dict(
                type='constant'
            ),
    ...
    def exec_module(self, **kwargs):
        ...
        if not old_response:
            self.log("DedicatedHostGroup instance doesn't exist")
            ...
            self.log('DedicatedHostGroup instance already exists')
        ...
        if (self.to_do == Actions.Create) or (self.to_do == Actions.Update):
            self.log('Need to Create / Update the DedicatedHostGroup instance')
            ...
            self.log('DedicatedHostGroup instance deleted')
            self.results['changed'] = True
            ...
            self.log('DedicatedHostGroup instance unchanged')
    ...
    def get_resource(self):
        ...
        try:
            ...
            # self.log("DedicatedHostGroup instance : {0} found".format(response.name))
        except CloudError as e:
            self.log('Did not find the DedicatedHostGroup instance.')
        if found is True:
            return response
