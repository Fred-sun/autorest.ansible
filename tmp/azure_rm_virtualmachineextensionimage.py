...
class AzureRMVirtualMachineExtensionImage(AzureRMModuleBaseExt):
    ...
    def exec_module(self, **kwargs):
        ...
        if not old_response:
            self.log("VirtualMachineExtensionImage instance doesn't exist")
            ...
            self.log('VirtualMachineExtensionImage instance already exists')
        ...
        if (self.to_do == Actions.Create) or (self.to_do == Actions.Update):
            self.log('Need to Create / Update the VirtualMachineExtensionImage instance')
            ...
            self.log('VirtualMachineExtensionImage instance deleted')
            self.results['changed'] = True
            ...
            self.log('VirtualMachineExtensionImage instance unchanged')
    ...
    def get_resource(self):
        ...
        try:
            ...
            # self.log("VirtualMachineExtensionImage instance : {0} found".format(response.name))
        except CloudError as e:
            self.log('Did not find the VirtualMachineExtensionImage instance.')
        if found is True:
            return response
