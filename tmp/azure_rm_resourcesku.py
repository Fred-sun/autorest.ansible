...
class AzureRMResourceSku(AzureRMModuleBaseExt):
    ...
    def exec_module(self, **kwargs):
        ...
        if not old_response:
            self.log("ResourceSku instance doesn't exist")
            ...
            self.log('ResourceSku instance already exists')
        ...
        if (self.to_do == Actions.Create) or (self.to_do == Actions.Update):
            self.log('Need to Create / Update the ResourceSku instance')
            ...
            self.log('ResourceSku instance deleted')
            self.results['changed'] = True
            ...
            self.log('ResourceSku instance unchanged')
    ...
    def get_resource(self):
        ...
        try:
            ...
            # self.log("ResourceSku instance : {0} found".format(response.name))
        except CloudError as e:
            self.log('Did not find the ResourceSku instance.')
        if found is True:
            return response
