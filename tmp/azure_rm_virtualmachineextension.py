...
class AzureRMVirtualMachineExtension(AzureRMModuleBaseExt):
    ...
    def exec_module(self, **kwargs):
        ...
        if not old_response:
            self.log("VirtualMachineExtension instance doesn't exist")
            ...
            self.log('VirtualMachineExtension instance already exists')
        ...
        if (self.to_do == Actions.Create) or (self.to_do == Actions.Update):
            self.log('Need to Create / Update the VirtualMachineExtension instance')
            ...
            self.log('VirtualMachineExtension instance deleted')
            self.results['changed'] = True
            ...
            self.log('VirtualMachineExtension instance unchanged')
    ...
    def get_resource(self):
        ...
        try:
            ...
            # self.log("VirtualMachineExtension instance : {0} found".format(response.name))
        except CloudError as e:
            self.log('Did not find the VirtualMachineExtension instance.')
        if found is True:
            return response
