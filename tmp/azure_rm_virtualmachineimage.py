...
class AzureRMVirtualMachineImage(AzureRMModuleBaseExt):
    ...
    def exec_module(self, **kwargs):
        ...
        if not old_response:
            self.log("VirtualMachineImage instance doesn't exist")
            ...
            self.log('VirtualMachineImage instance already exists')
        ...
        if (self.to_do == Actions.Create) or (self.to_do == Actions.Update):
            self.log('Need to Create / Update the VirtualMachineImage instance')
            ...
            self.log('VirtualMachineImage instance deleted')
            self.results['changed'] = True
            ...
            self.log('VirtualMachineImage instance unchanged')
    ...
    def get_resource(self):
        ...
        try:
            ...
            # self.log("VirtualMachineImage instance : {0} found".format(response.name))
        except CloudError as e:
            self.log('Did not find the VirtualMachineImage instance.')
        if found is True:
            return response
