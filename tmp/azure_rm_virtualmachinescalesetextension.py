...
class AzureRMVirtualMachineScaleSetExtension(AzureRMModuleBaseExt):
    def __init__(self):
        self.module_arg_spec = dict(
            ...
            provision_after_extensions=dict(
                type='list',
                disposition='/properties/provisionAfterExtensions'
            ),
            expand=dict(
                type='str'
            ),
    ...
    def exec_module(self, **kwargs):
        ...
        if not old_response:
            self.log("VirtualMachineScaleSetExtension instance doesn't exist")
            ...
            self.log('VirtualMachineScaleSetExtension instance already exists')
        ...
        if (self.to_do == Actions.Create) or (self.to_do == Actions.Update):
            self.log('Need to Create / Update the VirtualMachineScaleSetExtension instance')
            ...
            self.log('VirtualMachineScaleSetExtension instance deleted')
            self.results['changed'] = True
            ...
            self.log('VirtualMachineScaleSetExtension instance unchanged')
    ...
    def get_resource(self):
        ...
        try:
            ...
            # self.log("VirtualMachineScaleSetExtension instance : {0} found".format(response.name))
        except CloudError as e:
            self.log('Did not find the VirtualMachineScaleSetExtension instance.')
        if found is True:
            return response
