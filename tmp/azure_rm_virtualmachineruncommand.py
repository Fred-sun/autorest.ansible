...
class AzureRMVirtualMachineRunCommand(AzureRMModuleBaseExt):
    ...
    def exec_module(self, **kwargs):
        ...
        if not old_response:
            self.log("VirtualMachineRunCommand instance doesn't exist")
            ...
            self.log('VirtualMachineRunCommand instance already exists')
        ...
        if (self.to_do == Actions.Create) or (self.to_do == Actions.Update):
            self.log('Need to Create / Update the VirtualMachineRunCommand instance')
            ...
            self.log('VirtualMachineRunCommand instance deleted')
            self.results['changed'] = True
            ...
            self.log('VirtualMachineRunCommand instance unchanged')
    ...
    def get_resource(self):
        ...
        try:
            ...
            # self.log("VirtualMachineRunCommand instance : {0} found".format(response.name))
        except CloudError as e:
            self.log('Did not find the VirtualMachineRunCommand instance.')
        if found is True:
            return response
