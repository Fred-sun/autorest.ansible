...
class AzureRMProximityPlacementGroup(AzureRMModuleBaseExt):
    def __init__(self):
        self.module_arg_spec = dict(
            ...
            proximity_placement_group_type=dict(
                type='choice',
                disposition='/properties/proximityPlacementGroupType'
            ),
            colocation_status=dict(
                type='dict',
                disposition='/properties/colocationStatus',
                options=dict(
                    code=dict(
                        type='str',
                        disposition='/code'
    ...
    def exec_module(self, **kwargs):
        ...
        if not old_response:
            self.log("ProximityPlacementGroup instance doesn't exist")
            ...
            self.log('ProximityPlacementGroup instance already exists')
        ...
        if (self.to_do == Actions.Create) or (self.to_do == Actions.Update):
            self.log('Need to Create / Update the ProximityPlacementGroup instance')
            ...
            self.log('ProximityPlacementGroup instance deleted')
            self.results['changed'] = True
            ...
            self.log('ProximityPlacementGroup instance unchanged')
    ...
    def get_resource(self):
        ...
        try:
            ...
            # self.log("ProximityPlacementGroup instance : {0} found".format(response.name))
        except CloudError as e:
            self.log('Did not find the ProximityPlacementGroup instance.')
        if found is True:
            return response
