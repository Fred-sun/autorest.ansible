...
class AzureRMProximityPlacementGroup(AzureRMModuleBaseExt):
    ...
    def create_update_resource(self):
        try:
            response = self.mgmt_client.proximityplacementgroups.create_or_update(resource_group_name=self.resource_group_name,
    ...
    def delete_resource(self):
        try:
            response = self.mgmt_client.proximityplacementgroups.delete(resource_group_name=self.resource_group_name,
                                                                        proximity_placement_group_name=self.proximity_placement_group_name)
    ...
    def get_resource(self):
        found = False
        try:
            response = self.mgmt_client.proximityplacementgroups.get(resource_group_name=self.resource_group_name,
                                                                     proximity_placement_group_name=self.proximity_placement_group_name)
        except CloudError as e:
            return False
        return response.as_dict()
