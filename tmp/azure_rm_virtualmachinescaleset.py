      ...
      plan:
        description:
          - >-
            ...
            marketplace image that you want to use and then click **Want to
          ...
          user_assigned_identities:
            description:
              - >-
                ...
                scale set. The user identity dictionary key references will be
          ...
          mode:
            description:
              - >-
                ...
                application of updates to virtual machines in the scale set. You
                do this by using the manualUpgrade action.:code:`<br
              ...
              max_batch_instance_percent:
                description:
                  - >-
                    ...
                    will be upgraded simultaneously by the rolling upgrade in
                    one batch. As this is a maximum, unhealthy instances in
                    previous or future batches can cause the percentage of
                    instances in a batch to decrease to ensure higher
              ...
              max_unhealthy_upgraded_instance_percent:
                description:
                  - >-
                    ...
                    that can be found to be in an unhealthy state. This check
                    will happen after each batch is upgraded. If this percentage
                    is ever exceeded, the rolling update aborts. The default
                    value for this parameter is 20%.
                type: integer
          ...
          grace_period:
            description:
              - >-
                ...
                repairs. The time duration should be specified in ISO 8601
                format. The minimum allowed grace period is 30 minutes (PT30M),
                which is also the default value. The maximum allowed grace
              ...
              computer_name_prefix:
                description:
                  - >-
                    ...
                    machines in the scale set. Computer name prefixes must be 1
                ...
                description:
                  - >-
                    ...
                    **Max-length (Linux):** 64 characters
                    ...
                    on Linux that should not be used in this field, see
                ...
                description:
                  - >-
                    ...
                    **Max-length (Windows):** 123 characters
                    ...
                    fulfilled :code:`<br>` Has lower characters :code:`<br>`Has
                    upper characters :code:`<br>` Has a digit :code:`<br>` Has a
              ...
              custom_data:
                description:
                  - >-
                    ...
                    base-64 encoded string is decoded to a binary array that is
                    saved as a file on the Virtual Machine. The maximum length
                    of the binary array is 65535 bytes. :code:`<br>`:code:`<br>`
                  ...
                  enable_automatic_updates:
                    description:
                      - >-
                        ...
                        this property can be updated and updates will take
                      ...
                      patch_mode:
                        description:
                          - >-
                            ...
                            **Manual** - You  control the application of patches
                            to a virtual machine. You do this by applying
                            ...
                            - The virtual machine will automatically be updated
                            by the OS. The property
                            WindowsConfiguration.enableAutomaticUpdates must be
                          ...
                          certificate_url:
                            description:
                              - >-
                                ...
                                secret to the Key Vault, see `Add a key or
              ...
              linux_configuration:
                description:
                  - >-
                    ...
                    machine. :code:`<br>`:code:`<br>`For a list of supported
                          ...
                          path:
                            description:
                              - >-
                                ...
                                exists, the specified key is appended to the
                      ...
                      certificate_store:
                        description:
                          - >-
                            ...
                            the Virtual Machine to which the certificate should
                            be added. The specified certificate store is
              ...
              image_reference:
                description:
                  - >-
                    ...
                    images, or virtual machine images. This element is required
                    when you want to use a platform image, marketplace image, or
                    virtual machine image, but is not used in other creation
                    operations.
                type: dict
                suboptions:
                  publisher:
                  ...
                  version:
                    description:
                      - >-
                        ...
                        will not automatically update after deploy time even if
                  ...
                  create_option:
                    description:
                      - >-
                        ...
                        machine. If you are using a platform image, you also use
                        the imageReference element described above. If you are
                      ...
                      placement:
                        description:
                          - >-
                            ...
                            :code:`<br>`:code:`<br>` Default: **CacheDisk** if
                            one is configured for the VM size otherwise
                  ...
                  lun:
                    description:
                      - >-
                        ...
                        therefore must be unique for each data disk attached to
                        a VM.
                    required: true
                    type: integer
                  caching:
                      ...
                      load_balancer_backend_address_pools:
                        description:
                          - >-
                            ...
                            load balancer. Multiple scale sets cannot use the
              ...
              encryption_at_host:
                description:
                  - >-
                    ...
                    itself. :code:`<br>`:code:`<br>` Default: The Encryption at
                    host will be disabled unless this property is set to true
                    for the resource.
                type: bool
          diagnostics_profile:
            description:
              ...
              boot_diagnostics:
                description:
                  - >-
                    ...
                    your console log. :code:`<br>`:code:`<br>` Azure also
                    enables you to see a screenshot of the VM from the
                    hypervisor.
                type: dict
                suboptions:
                  enabled:
                  ...
                  storage_uri:
                    description:
                      - >-
                        ...
                        while enabling boot diagnostics, managed storage will be
                        used.
                    type: str
          extension_profile:
            description:
                  ...
                  force_update_tag:
                    description:
                      - >-
                        ...
                        previous value, the extension handler will be forced to
                        update even if the extension configuration has not
                        changed.
                    type: str
                  publisher:
                    description:
                  ...
                  auto_upgrade_minor_version:
                    description:
                      - >-
                        ...
                        versions unless redeployed, even with this property set
                        to true.
                    type: bool
          ...
          license_type:
            description:
              - >-
                ...
                on-premises. This element is only used for images that contain
                the Windows Server operating system. :code:`<br>`:code:`<br>`
                Possible values are: :code:`<br>`:code:`<br>` Windows_Client
                :code:`<br>`:code:`<br>` Windows_Server :code:`<br>`:code:`<br>`
                If this element is included in a request for an update, the
                value must match the initial value. This value cannot be
                updated. :code:`<br>`:code:`<br>` For more information, see
              ...
              max_price:
                description:
                  - >-
                    ...
                    evicting a Azure Spot VM/VMSS if the current Azure Spot
      ...
      single_placement_group:
        description:
          - >-
            ...
            max size 100 virtual machines. NOTE: If singlePlacementGroup is
            true, it may be modified to false. However, if singlePlacementGroup
      ...
      additional_capabilities:
        description:
          - >-
            ...
            Virtual Machines have the capability to support attaching managed
          ...
          rules:
            description:
              - >-
                ...
                are not protected from scale-in will be chosen for removal. For
                zonal virtual machine scale sets, the scale set will first be
